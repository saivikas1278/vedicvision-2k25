      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold flex items-center">
              <FaAppleAlt className="mr-3 text-green-500" /> Nutrition Tracker
            </h1>
          </div>
          <button
            onClick={() => navigate('/fitness/sports-nutrition')}
        ...
        <div className="mb-6 flex justify-between items-center">
          <input
            ...
            className="px-4 py-2 bg-[#24283b] border border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white"
          />
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
          ...
          <div className="bg-[#24283b] rounded-xl shadow-lg p-4">
            <h3 className="text-sm font-medium text-gray-400 mb-2">Calories</h3>
            <div className="flex items-center justify-between mb-2">
              <span className="text-2xl font-bold text-blue-500">{Math.round(dailyIntake.calories)}</span>
          ...
          {/* Protein */}
          <div className="bg-[#24283b] rounded-xl shadow-lg p-4">
            <h3 className="text-sm font-medium text-gray-400 mb-2">Protein (g)</h3>
            <div className="flex items-center justify-between mb-2">
              <span className="text-2xl font-bold text-red-500">{Math.round(dailyIntake.protein)}</span>
          ...
          {/* Carbs */}
          <div className="bg-[#24283b] rounded-xl shadow-lg p-4">
            <h3 className="text-sm font-medium text-gray-400 mb-2">Carbs (g)</h3>
            <div className="flex items-center justify-between mb-2">
              <span className="text-2xl font-bold text-yellow-500">{Math.round(dailyIntake.carbs)}</span>
          ...
          {/* Fat */}
          <div className="bg-[#24283b] rounded-xl shadow-lg p-4">
            <h3 className="text-sm font-medium text-gray-400 mb-2">Fat (g)</h3>
            <div className="flex items-center justify-between mb-2">
              <span className="text-2xl font-bold text-purple-500">{Math.round(dailyIntake.fat)}</span>
          ...
          {/* Water */}
          <div className="bg-[#24283b] rounded-xl shadow-lg p-4">
            <h3 className="text-sm font-medium text-gray-400 mb-2">Water (glasses)</h3>
            <div className="flex items-center justify-between mb-2">
              <span className="text-2xl font-bold text-cyan-500">{waterIntake}</span>
              <span className="text-sm text-gray-500">/ {goals.water}</span>
            </div>
            <div className="flex space-x-2">
              <button
                onClick={() => addWater(1)}
                className="flex-1 px-2 py-1 bg-cyan-900 hover:bg-cyan-800 text-cyan-100 text-sm rounded transition-colors"
              >
                +1
              </button>
              <button
                onClick={removeWater}
                className="flex-1 px-2 py-1 bg-gray-700 hover:bg-gray-600 text-gray-200 text-sm rounded transition-colors"
              >
                -1
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {mealTypes.map(mealType => (
            <div key={mealType.id} className="bg-[#24283b] rounded-xl shadow-lg p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  <p className="text-lg font-semibold text-blue-500">
                    {Math.round(getMealCalories(mealType.id))} cal
                  </p>
                  <button
                    onClick={() => {
              ...
              <div className="space-y-2">
                {getMealsByType(mealType.id).map(meal => (
                  <div key={meal.id} className="flex items-center justify-between p-3 bg-[#1a1b26] rounded-lg">
                    <div>
        ...
        {showAddFood && (
          <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-[#24283b] rounded-xl shadow-xl p-6 w-full max-w-md mx-4">
              <div className="flex items-center justify-between mb-4">
              ...
              <div className="mb-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-[#1a1b26] border border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
              </div>
              ...
              <div className="max-h-64 overflow-y-auto space-y-2">
                {filteredFoods.map(food => (
                  <div key={food.id} className="flex items-center justify-between p-3 border border-gray-700 rounded-lg hover:bg-[#1a1b26] transition-colors">
                    <div>
