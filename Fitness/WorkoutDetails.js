      ...
      setWorkout({
        ...
        exercises: [
          ...
          },
          {
            ...
            videoUrl: "/images/workout%20videos/video2.mp4"
          },
          {
            name: "Squats",
            sets: 4,
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-[#24283b] rounded-xl shadow-lg p-6 mb-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold">Workout Details</h2>
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                  workout.difficulty === 'beginner' ? 'bg-green-600 bg-opacity-20 text-green-400' :
                  workout.difficulty === 'intermediate' ? 'bg-yellow-600 bg-opacity-20 text-yellow-400' :
            ...
            {exercises.length > 0 && (
              !isWorkoutActive ? (
                ...
                <div className="bg-[#24283b] rounded-xl shadow-lg p-6 mb-6">
                  <h3 className="text-lg font-semibold mb-4">Workout in Progress</h3>
            ...
            {isWorkoutActive && currentExercise && exercises.length > 0 && (
              <div className="bg-[#24283b] rounded-xl shadow-lg p-6">
                ...
                <div className="bg-[#1a1b26] rounded-lg p-4">
                  ...
                  <p className="text-gray-400 mb-4">{currentExercise.description}</p>
                  
                  {/* Video Player */}
                  {currentExercise.videoUrl && (
                    <div className="mb-4">
                      <div className="mb-2 text-sm text-gray-400">
                        Video: {currentExercise.videoUrl}
                      </div>
                      <video
